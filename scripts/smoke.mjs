...
checks.push(['部门标签在表头行', ehtml.includes('>部门主管意见</th>') && ehtml.indexOf('部门主管意见') < ehtml.indexOf('领导审批')])
checks.push(['领导标签+两空白框', (ehtml.match(/exp-label-cell/g) || []).length === 1 && (ehtml.match(/exp-blank-box/g) || []).length >= 2])
checks.push(['空白框延伸到合计', ehtml.includes('rowspan="2"') && ehtml.includes('exp-blank-box')])
